...
import { CqButton, CqPasswordInput, CqFormField } from "@keycloak-theme/shared/ui";
            ...
            >
                ...
                <div className="flex gap-3 mt-2">
                    {isAppInitiatedAction && (
                        <CqButton variant="secondary" size="lg" name="cancel-aia" value="true" type="submit" style={{ flex: 1 }}>
                            {msgStr("doCancel")}
                        </CqButton>
                    )}
                    <CqButton
