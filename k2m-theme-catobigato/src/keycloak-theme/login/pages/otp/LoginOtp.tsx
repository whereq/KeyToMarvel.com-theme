            ...
            >
                    ...
                    <div className="flex flex-col gap-2">
                        {otpLogin.userOtpCredentials.map((otpCredential, index) => (
                            <label
                                ...
                                className="flex items-center gap-3 p-3 cursor-pointer rounded-[var(--cb-radius-sm)]"
                                style={{
                            ...
                            >
                                <input
                                    ...
                                    className="accent-[var(--cb-orange-400)]"
                                />
                                <span style={{ fontSize: "0.875rem", color: "var(--cb-text-primary)" }}>
                ...
                >
                    <CbInput
                        ...
                        autoFocus
                        hasError={hasError}
                        style={{ letterSpacing: "0.4em", fontSize: "1.25rem", textAlign: "center", fontFamily: "var(--cb-font-mono)" }}
                    />
                </CbFormField>
