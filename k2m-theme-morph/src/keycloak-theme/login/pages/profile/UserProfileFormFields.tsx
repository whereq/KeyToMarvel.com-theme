    ...
    return (
        <>
            <input
                ...
                className={`kcClsx("kcInputClass") w-full px-3 py-2 bg-gray-700 text-gray-200 rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-500`}
                ...
                placeholder={
                    attribute.annotations.inputTypePlaceholder === undefined
                        ? `${advancedMsgStr(attribute.displayName ?? "")}${attribute.required ? " *" : ""}`
