...
export default function LoginUpdateProfile(props: LoginUpdateProfileProps) {
    ...
    return (
        ...
        >
            <form id="kc-update-profile-form" className={`${kcClsx("kcFormClass")} space-y-4 bg-gray-800 p-4 rounded-sm`} action={url.loginAction} method="post">
                ...
                <div className={kcClsx("kcFormGroupClass")}>
                    ...
                    <div id="kc-form-buttons" 
                        className={`kcClsx("kcFormButtonsClass") 
                            px-4 py-2 bg-blue-600 rounded-sm 
