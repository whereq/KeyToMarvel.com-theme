...
export type VgTemplateProps = TemplateProps<KcContext, I18n> & {
    /** "split" renders a two-column layout: brand panel on the left, card on the right. */
    layoutVariant?: "split";
    /** Content rendered in the left brand panel when layoutVariant="split". */
    leftPanelNode?: ReactNode;
};

export default function Template(props: VgTemplateProps) {
    const {
        displayInfo = false,
        displayMessage = true,
    ...
    /* ── Login card — shared between default and split layouts ── */
    const card = (
        <div
            id="vg-login-card"
            style={{
        ...
        >
            {/* Card header */}
            <div id="vg-card-header" style={{ padding: "28px 28px 0" }}>
                {(() => {
                        ...
                        return (
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <a
                                    ...
                                    style={{ fontSize: "0.75rem", color: "var(--vg-cyan-400)" }}
                                >
            ...
            <div id="vg-card-body" style={{ padding: "20px 28px 28px" }}>
                ...
                {/* Social providers (default position — below form) */}
                {socialProvidersNode && (
                ...
                {isAppInitiatedAction && (
                    <div className="mt-4 text-center">
                        <a
                            href={url.loginRestartFlowUrl}
                            style={{ fontSize: "0.8rem", color: "var(--vg-text-muted)" }}
                        >
                            {msg("doCancel")}
                        </a>
                    </div>
