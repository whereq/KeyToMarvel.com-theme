...
export default function AttributesGroupForm() {
  ...
  const onSubmit: SubmitHandler<FormFields> = async (values) => {
    ...
    // K2M-PATCH: Same race condition as NewAttributeSettings — translation
    // pre-loading may not complete before the user saves. The REST API does not
    // enforce this guard server-side, so we skip it. saveTranslations() still
    // persists any translations that were loaded.
