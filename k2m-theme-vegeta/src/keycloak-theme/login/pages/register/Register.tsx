...
export default function Register(props: Props) {
    ...
    // Terms acceptance is determined by the presence of termsAndConditions in the realm config
        ...
        <Template
            ...
            infoNode={
                <span style={{ color: "var(--vg-text-secondary)" }}>
                    ...
                    <a href={kcContext.url.loginUrl} style={{ color: "var(--vg-cyan-400)", fontWeight: 500 }}>
                        {advancedMsg("doLogIn")}
                    </a>
                </span>
            }
