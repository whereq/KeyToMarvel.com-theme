...
import { VgButton, VgPasswordInput, VgFormField } from "@keycloak-theme/shared/ui";
...
export default function LoginUpdatePassword(
    ...
    return (
        ...
        >
            ...
            >
                {/* Hidden field for password manager */}
                ...
                <div className="flex items-center justify-between mt-2 gap-4">
                    {isAppInitiatedAction && (
                        <button
                            ...
                            name="cancel-aia"
                            value="true"
                            style={{ background: "none", border: "none", cursor: "pointer", fontSize: "0.8rem", color: "var(--vg-text-muted)" }}
                        >
                            {msg("doCancel")}
                        </button>
                    )}
