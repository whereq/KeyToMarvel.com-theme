    ...
    return (
        ...
        >
            <div className="flex flex-col items-center gap-2 mb-5">
                ...
                <p style={{ color: "var(--vg-text-secondary)", textAlign: "center", fontSize: "0.875rem", margin: 0 }}>
            ...
            <form id="register" action={url.loginAction} method="post" className="flex flex-col gap-4">
                ...
                <VgFormField id="webauthnLabel" label={advancedMsg("webauthn-choose-authenticator-label")}>
                    <VgInput
                        tabIndex={2}
                        id="webauthnLabel"
                        name="webauthnLabel"
                        type="text"
                        autoComplete="off"
                        placeholder={advancedMsgStr("webauthn-choose-authenticator-label-desc")}
                    />
                </VgFormField>
