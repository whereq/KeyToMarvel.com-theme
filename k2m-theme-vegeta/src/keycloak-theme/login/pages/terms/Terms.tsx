    ...
    return (
        ...
        >
            ...
            <form action={url.loginAction} method="post" className="flex gap-3">
                <VgButton variant="secondary" size="md" fullWidth type="submit" name="cancel" value="cancel">
                    {msgStr("doDecline")}
                </VgButton>
                <VgButton variant="frontend" size="md" fullWidth type="submit" name="accept" value="accept">
                    {msgStr("doAccept")}
                </VgButton>
            </form>
        </Template>
